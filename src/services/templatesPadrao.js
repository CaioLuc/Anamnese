...
export const TEMPLATE_ADULTO = {
  ...
  campos: [
    ...
    { id: 'f_ecivil', ordem: 1, tipo: 'radio', label: 'Estado Civil', opcoes: ['Solteiro(a)', 'Casado(a)', 'União Estável', 'Divorciado(a)', 'Viúvo(a)'], obrigatorio: false },
    { id: 'f_escol', ordem: 2, tipo: 'select', label: 'Escolaridade', opcoes: ['Fundamental Incompleto', 'Fundamental Completo', 'Médio Incompleto', 'Médio Completo', 'Superior Incompleto', 'Superior Completo', 'Pós-graduação'], obrigatorio: false },
    { id: 'f_prof', ordem: 3, tipo: 'text', label: 'Profissão / Ocupação', placeholder: 'Ex: Professora, Engenheiro...', obrigatorio: false },
    { id: 'f_end', ordem: 4, tipo: 'text', label: 'Endereço Completo', placeholder: 'Rua, número, bairro, cidade', obrigatorio: false },
    { id: 'f_email', ordem: 5, tipo: 'text', label: 'E-mail', placeholder: 'email@exemplo.com', obrigatorio: false },
    { id: 'f_enc', ordem: 6, tipo: 'text', label: 'Como conheceu / Encaminhamento', placeholder: 'Ex: Indicação médica, redes sociais...', obrigatorio: false },

    { id: 's2', ordem: 7, tipo: 'section', label: 'II. Queixa Principal e História Atual' },
    { id: 'f_queixa', ordem: 8, tipo: 'textarea', label: 'Queixa Principal', placeholder: 'Descreva com as palavras do próprio paciente o motivo da consulta...', obrigatorio: true },
    { id: 'f_inicio', ordem: 9, tipo: 'textarea', label: 'Início e Evolução dos Sintomas', placeholder: 'Quando começou? O que desencadeou? Como evoluiu?', obrigatorio: false },
    { id: 'f_trat_ant', ordem: 10, tipo: 'textarea', label: 'Tratamentos Anteriores', placeholder: 'Já fez psicoterapia antes? Por quanto tempo? Com qual resultado?', obrigatorio: false },
